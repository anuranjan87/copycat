    ...
    >
      ...
      <div className="relative z-10">
        <div className="flex items-center justify-between mb-4">
          <div className="p-3 rounded-xl bg-pink-500/10 text-pink-300 transition-all duration-300 group-hover:bg-pink-500/20">
...
// ================= MAIN DASHBOARD =================
export default function DesktopDashboard({ params }: { params: Promise<{ username: string }> }) {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-rose-950/20 text-white px-6 py-10">
    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-rose-950/20 text-white overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className="absolute top-20 right-40 w-96 h-96 bg-pink-500/30 rounded-full animate-float blur-3xl" />
          <div className="absolute bottom-20 left-20 w-72 h-72 bg-rose-400/20 rounded-full animate-float blur-2xl" style={{ animationDelay: '3s' }} />
        </div>
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-12 py-10 space-y-12 mt-20">
          ...
          <div className="animate-[slideUp_0.6s_ease-out] space-y-2">
            ...
            <div className="flex items-center gap-3">
              ...
              <Flower2 className="h-6 w-6 text-amber-300/70 ml-2" />
            </div>
          </div>
          ...
          {/* Chart Card */}
          <div className="group relative overflow-hidden rounded-3xl border border-white/20 bg-black/40 backdrop-blur-xl p-8 transition-all duration-500 hover:border-rose-300/40 animate-[slideUp_0.6s_ease-out_0.3s_forwards] opacity-0 shadow-[0_8px_20px_rgba(255,182,193,0.15),0_20px_60px_rgba(255,105,180,0.08)]">
            ...
            <div className="relative z-10 space-y-6">
              <div className="flex flex-wrap items-center justify-between gap-4">
                <div className="flex items-center gap-4">
                  <div className="p-3 rounded-xl bg-pink-500/10 text-pink-300 group-hover:scale-110 transition-transform">
                    <Eye className="h-6 w-6" />
                  </div>
                  <div>
                    <h2 className="text-3xl font-bold rox">Performance</h2>
                    <p className="text-sm text-white/40 mt-1">Traffic trends & insights</p>
                  </div>
                </div>
                ...
                <ResponsiveContainer width="100%" height="100%">
                  <AreaChart data={chartData} margin={{ left: 30, right: 30, top: 20, bottom: 10 }}>
                    ...
                    <Tooltip
                      ...
                      labelStyle={{ color: "#fce7f3", fontSize: "13px", fontWeight: 600 }}
                      formatter={(v: any) => [
                    ...
                    <Area
                      ...
                      activeDot={{ r: 8, fill: "#f472b6", strokeWidth: 2 }}
                    />
                  </AreaChart>
                </ResponsiveContainer>
              </div>
          ...
          {/* Enquiries Card */}
          <div className="group relative overflow-hidden rounded-2xl border border-white/10 bg-black/40 backdrop-blur-xl p-8 transition-all duration-500 hover:border-rose-300/40 animate-[slideUp_0.6s_ease-out_0.6s_forwards] opacity-0 shadow-[0_8px_20px_rgba(255,182,193,0.15),0_20px_60px_rgba(255,105,180,0.08)]">
            <div className="absolute inset-0 bg-gradient-to-br from-rose-500/5 to-amber-300/5 opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
            <div className="relative z-10">
              {!selectedEnquiry ? (
                <div className="space-y-6">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-4">
                      <div className="p-1 rounded-xl bg-pink-500/10 text-pink-300 scale-110 transition-transform">
                    ...
                    <div className="flex items-center gap-2 bg-white/5 px-4 py-2 rounded-full border border-white/10">
                      <Asterisk className="h-4 w-4 text-rose-400" />
                          ...
                          >
                            ...
                            <div className="flex items-center justify-between gap-3">
                              <div className="flex items-center gap-4 min-w-0 flex-1">
                                <div className="p-3 rounded-lg bg-pink-500/10 group-hover/item:bg-pink-500/20 transition-all flex-shrink-0">
                                  <Mail className="h-5 w-5 text-pink-300" />
                                </div>
                                <div className="flex flex-col min-w-0 flex-1">
                                  <span className="text-sm font-semibold text-stone-300 truncate">
                                    {e.name || getEmail(e)}
                                  </span>
                              ...
                              <ChevronRight className="h-5 w-5 text-white/30 group-hover/item:text-rose-400 group-hover/item:translate-x-1 transition-all flex-shrink-0" />
                            </div>
                          </div>
                        ))}
                      </div>
                ...
                <div className="animate-[slideIn_0.4s_ease-out] space-y-8">
                  ...
                  <div className="flex items-center gap-3 px-4 py-3 rounded-lg bg-white/5 border border-white/10">
                    <CalendarDays className="h-5 w-5 text-rose-400 flex-shrink-0" />
                  ...
                  <div className="grid gap-1">
                    {Object.entries(selectedEnquiry)
                      ...
                      .map(([k, v], idx) => (
                        ...
                        >
                          <p className="text-xs font-mono uppercase tracking-widest text-rose-300 mb-2 font-bold">
                            {k}
                          </p>
                  ...
                  <Button
                    onClick={() => setSelectedEnquiry(null)}
                    className="w-full bg-rose-500 hover:bg-rose-600 text-white font-semibold py-3 rounded-lg transition-all hover:scale-[1.02] active:scale-95"
                  >
                    Back to Messages
                  </Button>
                </div>
