export default function support () {
    ...
    return( 
        <>  
<div className="container mx-auto px-2 py-8 max-w-md"> {/* Main container for the help and support page */}
    <h1 className="text-xs font-bold text-gray-900 mb-4">Help & Support</h1> {/* Main title with extra small font */}
    ...
    <p className="text-gray-600 mb-4 text-xs">For immediate assistance, use our live chat feature available on our website during business hours.</p> {/* Live chat information */}
    <h2 className="text-xs font-semibold text-gray-800 mb-2">5. Community Forum</h2> {/* Section title with extra small font */}
    <p className="text-gray-600 mb-4 text-xs">Join our community forum to connect with other users and share tips and experiences.</p> {/* Community forum information */}
</div> </>)
}